...
from dhwb import wbi_fastrun
from dhwb.datatypes import BaseDataType
from dhwb.models.claims import Claim, Claims
from dhwb.wbi_enums import ActionIfExists, EntityField
from dhwb.wbi_exceptions import MissingEntityException
from dhwb.wbi_helpers import delete_page, edit_entity, mediawiki_api_call_helper
...
class BaseEntity:
    ...
    def download_entity_ttl(self, **kwargs) -> str:
        from dhwb.wbi_helpers import download_entity_ttl
        if self.id:
